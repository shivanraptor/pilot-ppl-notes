---
layout: default
title: Computer-Based Aptitude Tests
---
# Computer-Based Aptitude Tests (Aon / Cut-E)

**Navigation:** [Interview hub](index.md) | [Home](../index.md)

> **Common mistake:** preparing only the **monitoring (moving dots)** test. Recent Cathay cadet cycles report **multiple modules** in one proctored session (often via **Microsoft Teams** with camera on).
...
| Source | What it says |
| --- | --- |
| [Cathay careers — cadet](https://careers.cathaypacific.com/en/careers/jobs/hong-kong/cadet-pilot-programme-29631) | Computer-based assessment is part of selection; details when shortlisted |
...
**Navigation:** [Interview hub](index.md) | [ICAO English](icao_english.md) | [HR & behavioural](hr_behavioural.md)
